return PlaceObj('ModDef', {
	...
	'last_changes', "2.14\n\nadded a mod option that stops the function that changes explosives to IEDs. use this option if facing desyncs in coop games.",
	'dependencies', {
