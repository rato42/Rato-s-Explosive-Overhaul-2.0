return PlaceObj('ModDef', {
	...
	'last_changes', '2.17a\n\n-(FOR REAL THIS TIME) fixed a bug that would make grenade launches not possible on some maps\n-also removed something called "sanity check" so more "creative" bounces can occur! its probably harmless :)',
	'dependencies', {
	...
	'default_options', {
		...
		explosive_dmg = "100",
		extra_proximityExplosive_radius = "1",
