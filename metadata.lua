return PlaceObj('ModDef', {
	...
	'last_changes', "2.05\n\nsome tweaks on deviation to help prevent hitting close objects\ntweak to throw accuracy\nsligth increase to molotov and pipe bomb  range\nsmall decrease to shrapnel damage\ndecrease to shrapnel dmg when outside the primary explosion radius",
	'id', "RATONADE",
	'author', "rato",
	'version_major', 2,
	'version_minor', 5,
