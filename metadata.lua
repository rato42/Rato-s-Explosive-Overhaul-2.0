return PlaceObj('ModDef', {
	...
	'last_changes', "2.10\n\nAdded a mod option that will let you customize the activation radius of proximity based explosives. Won't affect landmines. By default, this mod increases the radius by 1.",
	'id', "RATONADE",
	'author', "rato",
	'version_major', 2,
	'version_minor', 10,
