return PlaceObj('ModDef', {
	...
	'code', {
		...
		"Code/SOURCE_DynamicSpawnLandmine_GameInit.lua",
		"Code/SOURCE_MergeAndSplitIED.lua",
		"Code/COMBATACTION_ThrowGrenade.lua",
		"Code/FUNCTIONS_BounceGrenade.lua",
		"Code/FUNCTIONS_Compatibility.lua",
	...
	'default_options', {
		...
		ExplosiveNoiseIncrease = 400,
		GL_throw_diff = "Normal (0)",
		RPG_throw_diff = "Normal (0)",
		SkipIEDLootChanges = false,
		...
		explosive_dmg = "100",
		extra_proximityExplosive_radius = "0",
