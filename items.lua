return {
	...
	PlaceObj('ModItemOptionChoice', {
		'name', "mishap_option",
		'DisplayName', "Disastrous Mishap Chance %",
		'Help', "Multiplies the new mishap chance (makes the explosive explode in your hand). Set it to 0 to disable this mechanic.",
		'DefaultValue', "60 (default)",
		'ChoiceList', {
			"0",
			"10",
			"20",
