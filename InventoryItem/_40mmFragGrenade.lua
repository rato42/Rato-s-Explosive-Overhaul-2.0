...
DefineClass._40mmFragGrenade = {
	...
	AdditionalHint = T(926889899942, --[[ModItemInventoryItemCompositeDef _40mmFragGrenade AdditionalHint]] "<EO_description_hints>\n<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Inflicts <color EmStyle>Bleeding</color> in the epicenter"),
	Cost = 300,
